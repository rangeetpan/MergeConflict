 ...
 public:
  explicit MetricsConsentOverride(bool initial_state) : state_(initial_state) {
    ChromeMetricsServiceAccessor::SetMetricsAndCrashReportingForTesting(
        &state_);
    ChromeMetricsServiceAccessor::SetUrlReportingForTesting(&state_);
  ...
  ~MetricsConsentOverride() {
    ChromeMetricsServiceAccessor::SetMetricsAndCrashReportingForTesting(
        nullptr);
    ChromeMetricsServiceAccessor::SetUrlReportingForTesting(nullptr);
  }
...
class UkmBrowserTestBase : public SyncTest {
 public:
  UkmBrowserTestBase() : SyncTest(SINGLE_CLIENT) {
    ...
    scoped_feature_list_.InitWithFeatures(
        {ukm::kUkmFeature, features::edge::kEdgeEnableUkm},
 ...
 protected:
  ...
  // Prevent metrics reporting from being force enabled since we need to test
  // UKM consent.
  bool ForceEnableHistogramReporting() override { return false; }
...
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(RegularPlusGuestCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(OpenNonSyncCheck, 22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
IN_PROC_BROWSER_TEST_P(
    ...
    EDGE_DISABLED_PERMANENT(AddSyncedUserBirthYearAndGenderToProtoData,
                            24585205)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  test::DemographicsTestParams param = GetParam();
  MetricsConsentOverride metrics_consent(true);
...
// UkmTest.java.
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(ConsentAddedButNoSyncCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
...
// disables it.
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(SingleDisableExtensionsSyncCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
// disables it.
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(MultiDisableExtensionsSyncCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
// UkmTest.java.
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(SingleSyncSignoutCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(MultiSyncSignoutCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
IN_PROC_BROWSER_TEST_F(UkmBrowserTest,
                       EDGE_DISABLED_PERMANENT(ServiceListenerInitFailedCheck,
                                               22224671)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
IN_PROC_BROWSER_TEST_F(
    UkmBrowserTestWithSyncTransport,
    EDGE_DISABLED_PERMANENT(NotEnabledForSecondaryAccountSync, 22224614)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
  MetricsConsentOverride metrics_consent(true);
...
IN_PROC_BROWSER_TEST_P(UkmConsentParamBrowserTest,
                       EDGE_DISABLED_PERMANENT(GroupPolicyConsentCheck,
                                               22224614)) {
  ukm::UkmTestHelper ukm_test_helper(GetUkmService());
