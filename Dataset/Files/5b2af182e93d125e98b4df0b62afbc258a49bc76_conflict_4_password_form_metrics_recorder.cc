...
=======
>>>>>>> 07da121d7c5db52d12344bde8793a6312ceba310
...
void PasswordFormMetricsRecorder::LogSubmitPassed() {
  if (submit_result_ != kSubmitResultFailed) {
    if (HasGeneratedPassword(generated_password_status_)) {
      ...
      LogEdgePasswordGenerationEvent(
          EdgePasswordGenerationEvent::PASSWORD_SUBMITTED);
      ...
      // BEGIN_EDGE_AUTOFILL_CODE
      LogEdgePasswordGenerationEvent(
          EdgePasswordGenerationEvent::
              GENERATED_PASSWORD_NOT_USED_FOR_SUBMISSION);
      // END_EDGE_AUTOFILL_CODE
    }
  }
...
void PasswordFormMetricsRecorder::SetPasswordGenerationPopupShown(
  ...
  password_generation_popup_shown_ =
      generation_popup_was_shown
          ...
          : PasswordGenerationPopupShown::kNotShown;
  // BEGIN_EDGE_AUTOFILL_CODE
  if (generation_popup_was_shown) {
    LogEdgePasswordGenerationEvent(
        EdgePasswordGenerationEvent::GENERATION_POPUP_SHOWN);
    if (!generation_popup_shown_once_) {
      generation_popup_shown_once_ = true;
      MarkGenerationAvailable();
      LogEdgePasswordGenerationEvent(
          EdgePasswordGenerationEvent::GENERATION_POPUP_SHOWN_ONCE);
    }
  }
  // END_EDGE_AUTOFILL_CODE
}
...
void PasswordFormMetricsRecorder::LogEdgePasswordGenerationEvent(
    EdgePasswordGenerationEvent event) {
  base::UmaHistogramEnumeration("Microsoft.Autofill.PasswordGeneration.Event",
                                event);
}
