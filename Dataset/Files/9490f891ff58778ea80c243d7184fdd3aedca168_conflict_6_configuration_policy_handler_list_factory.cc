...
#include "chrome/browser/metrics/search_suggest_enabled_policy_handler.h"
...
#include "chrome/browser/policy/clear_data_on_exit_policy_handler.h"
#include "chrome/browser/policy/company_logo_policy_handler.h"
#include "chrome/browser/policy/developer_tools_policy_handler.h"
#include "chrome/browser/policy/edge_tracking_prevention_policy_handler.h"
#include "chrome/browser/policy/file_selection_dialogs_policy_handler.h"
#include "chrome/browser/policy/homepage_location_policy_handler.h"
#include "chrome/browser/policy/image_policy_handler.h"
#include "chrome/browser/policy/javascript_policy_handler.h"
<<<<<<< HEAD
#include "chrome/browser/policy/managed_bookmarks_policy_handler.h"
#include "chrome/browser/policy/managed_quicklinks_policy_handler.h"
=======
>>>>>>> f9c714a5ff055e1509fce4283d7a315ad560499f
#include "chrome/browser/policy/network_prediction_policy_handler.h"
#include "chrome/browser/policy/personalization_reporting_policy_handler.h"
...
#include "components/captive_portal/content/edge_pref_names.h"
...
#include "components/ntp/pref_names.h"
...
#include "components/safe_browsing/content/password_protection/password_protection_prefs.h"
#include "components/search_engines/default_search_policy_handler.h"
#include "components/search_engines/managed_search_engines_policy_handler.h"
#include "components/security_state/core/security_state_pref_names.h"
#include "components/signin/public/base/signin_pref_names.h"
#include "components/spellcheck/spellcheck_buildflags.h"
#include "components/sync/base/pref_names.h"
#include "components/sync/driver/edge_sync_history_policy_handler.h"
...
#include "third_party/microsoft_voices/buildflags/buildflags.h"
...
#if defined(OS_WIN)
#include "chrome/browser/dual_engine/dual_engine_prefs_win.h"
#endif
...
#include "components/edge_trust/common/pref_names.h"
...
const PolicyToPreferenceMapEntry kSimplePolicyMap[] = {
  ...
  { key::kAllowSurfGame,
    prefs::kAllowSurfGame,
    base::Value::Type::BOOLEAN },
#endif // defined(MICROSOFT_EDGE_BUILD)
  { key::kBingAdsSuppression,
    prefs::kBingAdsSuppression,
    base::Value::Type::BOOLEAN },
  ...
  #endif
  #if BUILDFLAG(ENABLE_SMARTSCREEN)
  { key::kSmartScreenEnabled,
    prefs::kSmartScreenEnabled,
    base::Value::Type::BOOLEAN },
  { key::kPreventSmartScreenPromptOverride,
    prefs::kDisableSmartScreenContinueAnyway,
    base::Value::Type::BOOLEAN },
  { key::kPreventSmartScreenPromptOverrideForFiles,
    prefs::kDisableSmartScreenDownloadAnyway,
    base::Value::Type::BOOLEAN },
  { key::kSmartScreenAllowListDomains,
    prefs::kSmartScreenAllowListDomains,
    base::Value::Type::LIST},
  { key::kSmartScreenForTrustedDownloadsEnabled,
    prefs::kSmartScreenForTrustedDownloadsEnabled,
    base::Value::Type::BOOLEAN },
  { key::kSmartScreenPuaEnabled,
    prefs::kSmartScreenPuaProtectionEnabled,
    base::Value::Type::BOOLEAN },
  #else
  { key::kSmartScreenAllowListDomains,
    password_protection::prefs::kSmartScreenAllowListDomains,
    base::Value::Type::LIST},
  #endif  // BUILDFLAG(ENABLE_SMARTSCREEN)
#if defined(OS_WIN)
  { key::kClickOnceEnabled,
    prefs::kClickOnceEnabled,
    base::Value::Type::BOOLEAN },
  { key::kDirectInvokeEnabled,
    prefs::kDirectInvokeEnabled,
    base::Value::Type::BOOLEAN },
  ...
  { key::kDownloadRestrictions,
    ...
    base::Value::Type::INTEGER },
  { key::kForceBingSafeSearch,
    prefs::kForceBingSafeSearch,
    base::Value::Type::INTEGER},
  ...
  { key::kForceYouTubeRestrict,
    ...
    base::Value::Type::INTEGER },
  { key::kGoToIntranetSiteForSingleWordEntryInAddressBar,
    omnibox::prefs::kSingleWordIntranet,
    base::Value::Type::BOOLEAN},
  { key::kAddressBarMicrosoftSearchInBingProviderEnabled,
    omnibox::prefs::kOmniboxMSBProviderEnabled,
    base::Value::Type::BOOLEAN},
  ...
  { key::kDefaultGeolocationSetting,
    ...
    base::Value::Type::INTEGER },
#if defined(OS_WIN)
  { key::kAllowTokenBindingForUrls,
    prefs::kManagedAllowTokenBindingForUrls,
    base::Value::Type::LIST },
#endif
  { key::kEnableOnlineRevocationChecks,
    prefs::kCertRevocationCheckingEnabled,
    base::Value::Type::BOOLEAN },
  { key::kForceCertificatePromptsOnMultipleMatches,
    prefs::kForceCertificatePromptsOnMultipleMatches,
    base::Value::Type::BOOLEAN },
  ...
  { key::kImportAutofillFormData,
    ...
    base::Value::Type::BOOLEAN },
  { key::kImportPaymentInfo,
    prefs::kImportPaymentInfo,
    base::Value::Type::BOOLEAN },
  { key::kImportBrowserSettings,
    prefs::kImportSettings,
    base::Value::Type::BOOLEAN },
  { key::kImportOpenTabs,
    prefs::kImportOpenTabs,
    base::Value::Type::BOOLEAN },
  { key::kImportExtensions,
    prefs::kImportExtensions,
    base::Value::Type::BOOLEAN },
  { key::kImportShortcuts,
    prefs::kImportShortcuts,
    base::Value::Type::BOOLEAN },
  { key::kImportCookies,
    prefs::kImportCookies,
    base::Value::Type::BOOLEAN },
  ...
  { key::kImportAutofillFormData,
    ...
    base::Value::Type::BOOLEAN },
  { key::kImportHomepage,
    prefs::kImportDialogHomepage,
    base::Value::Type::BOOLEAN },
  { key::kImportPaymentInfo,
    prefs::kImportDialogPaymentInfo,
    base::Value::Type::BOOLEAN },
  { key::kImportBrowserSettings,
    prefs::kImportDialogSettings,
    base::Value::Type::BOOLEAN },
  { key::kImportOpenTabs,
    prefs::kImportDialogOpenTabs,
    base::Value::Type::BOOLEAN },
  { key::kImportExtensions,
    prefs::kImportDialogExtensions,
    base::Value::Type::BOOLEAN },
  ...
  { key::kHideWebStoreIcon,
    ...
    base::Value::Type::BOOLEAN },
#endif
  { key::kNewTabPageHideDefaultTopSites,
    ntp_tiles::prefs::kHideDefaultTopSites,
    base::Value::Type::BOOLEAN },
#if EXCLUDED_FROM_EDGE
  ...
  { key::kEnableMediaRouter,
    ...
    base::Value::Type::BOOLEAN },
  { key::kWebRtcLocalhostIpHandling,
  ...
  { key::kAdvancedProtectionAllowed,
    ...
    base::Value::Type::BOOLEAN },
#endif
  { key::kSendSiteInfoToImproveServices,
  ...
  { key::kPrintPreviewUseSystemDefaultPrinter,
    ...
    base::Value::Type::BOOLEAN },
  { key::kNonRemovableProfileEnabled,
    prefs::kNonRemovableProfileEnabled,
    base::Value::Type::BOOLEAN },
#if EXCLUDED_FROM_EDGE
...
#if defined(OS_WIN)
  { key::kInternetExplorerIntegrationLevel,
    dual_engine::prefs::kInternetExplorerIntegrationLevel,
    base::Value::Type::INTEGER },
  { key::kSendIntranetToInternetExplorer,
    dual_engine::prefs::kSendIntranetToInternetExplorer,
    base::Value::Type::BOOLEAN },
  { key::kInternetExplorerIntegrationSiteList,
    dual_engine::prefs::kInternetExplorerIntegrationSiteList,
    base::Value::Type::STRING },
  { key::kInternetExplorerIntegrationSiteRedirect,
    dual_engine::prefs::kInternetExplorerIntegrationSiteRedirect,
    base::Value::Type::INTEGER },
#endif
  { key::kConfigureDoNotTrack,
    prefs::kEnableDoNotTrack,
    base::Value::Type::BOOLEAN },
  { key::kClearBrowsingDataOnExit,
    prefs::kClearDataOnExit,
    base::Value::Type::BOOLEAN },
  { key::kClearCachedImagesAndFilesOnExit,
    browsing_data::prefs::kDeleteCacheOnExit,
    base::Value::Type::BOOLEAN},
  { key::kFamilySafetySettingsEnabled,
    prefs::kFamilySafetySettingsEnabled,
    base::Value::Type::BOOLEAN },
  { key::kTrackingPrevention,
    prefs::kTrackingPreventionPolicy,
    base::Value::Type::INTEGER },
  { key::kAllowTrackingForUrls,
    prefs::kManagedAllowTrackingForUrls,
    base::Value::Type::LIST },
#if BUILDFLAG(ENABLE_MICROSOFT_VOICES)
  { key::kConfigureOnlineTextToSpeech,
    prefs::kConfigureOnlineTextToSpeech,
    base::Value::Type::BOOLEAN},
#endif
  { key::kEnableDomainActionsDownload,
    variations::prefs::kEnableDomainActionsDownload,
    base::Value::Type::BOOLEAN },
  { key::kEdgeCollectionsEnabled,
    prefs::kEnableEdgeCollections,
    base::Value::Type::BOOLEAN },
  { key::kResolveNavigationErrorsUseWebService,
    captive_portal::prefs::kResolveNavigationErrorsUseWebServiceEnabled,
    base::Value::Type::BOOLEAN },
  { key::kProactiveAuthEnabled,
    prefs::kProactiveAuthEnabled,
    base::Value::Type::BOOLEAN },
  { key::kAutoImportAtFirstRun,
    prefs::kAutoImportAtFirstRun,
    base::Value::Type::INTEGER },
  { key::kHideFirstRunExperience,
    prefs::kHideFirstRunExperience,
    base::Value::Type::BOOLEAN },
  { key::kExperimentationAndConfigurationServiceControl,
    variations::prefs::kExperimentationAndConfigurationServiceControl,
    base::Value::Type::INTEGER },
  { key::kCustomHelpLink,
    prefs::kCustomHelpLink,
    base::Value::Type::STRING },
  { key::kBackgroundTemplateListUpdatesEnabled,
...
#if defined(OS_WIN)
  { key::kDeleteDataOnMigration,
    prefs::kDeleteDataOnMigration,
    base::Value::Type::BOOLEAN },
  { key::kConfigureOnPremisesAccountAutoSignIn,
    prefs::kEdgeOnPremisesAutoSignInPolicy,
    base::Value::Type::INTEGER },
  { key::kConfigureShare,
    prefs::kConfigureShare,
    base::Value::Type::INTEGER},
#endif
...
#if !defined(OS_ANDROID)
  handlers->AddHandler(
      std::make_unique<ManagedSearchEnginesPolicyHandler>(chrome_schema));
#endif
=======
...
>>>>>>> f9c714a5ff055e1509fce4283d7a315ad560499f
  ...
  #if !EXCLUDED_FROM_EDGE
    handlers->AddHandler(std::make_unique<SearchSuggestEnabledPolicyHandler>());
  #endif
  ...
  handlers->AddHandler(
      std::make_unique<ImagePolicyHandler>(key::kNewTabPageBackgroundImage,
                                           ntp::prefs::kBackgroundImage));
  handlers->AddHandler(std::make_unique<CompanyLogoPolicyHandler>());
#if !defined(OS_ANDROID)
  handlers->AddHandler(
      std::make_unique<ManagedQuickLinksPolicyHandler>(chrome_schema));
#endif
  ...
  handlers->AddHandler(
      std::make_unique<syncer::EdgeSyncHistoryPolicyHandler>());
  ...
  handlers->AddHandler(std::make_unique<ClearDataOnExitPolicyHandler>());
  handlers->AddHandler(std::make_unique<TrackingPreventionPolicyHandler>());
  handlers->AddHandler(
      std::make_unique<PersonalizationReportingPolicyHandler>());
...
#if !EXCLUDED_FROM_EDGE
  handlers->AddHandler(std::make_unique<BrowserSigninPolicyHandler>(chrome_schema));
#endif
...
// one.
#if defined(OS_CHROMEOS) || defined(OS_ANDROID) || !EXCLUDED_FROM_EDGE
  ...
  handlers->AddHandler(std::make_unique<LegacyPoliciesDeprecatingPolicyHandler>(
      ...
      std::make_unique<SecureOriginPolicyHandler>(
          key::kOverrideSecurityRestrictionsOnInsecureOrigin, chrome_schema)));
#endif  // defined(OS_CHROMEOS) || defined(OS_ANDROID) || !EXCLUDED_FROM_EDGE
