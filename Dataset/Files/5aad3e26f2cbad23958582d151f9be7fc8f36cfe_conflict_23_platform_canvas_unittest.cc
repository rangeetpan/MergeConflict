...
TEST(PlatformCanvas, SkLayer) {
  EDGE_DISABLED_WCOS_PENDING(SkLayer, 22790288)
...
TEST(PlatformCanvas, ClipRegion) {
  EDGE_DISABLED_WCOS_PENDING(ClipRegion, 22790288)
...
TEST(PlatformCanvas, FillLayer) {
  EDGE_DISABLED_WCOS_PENDING(FillLayer, 22790288)
  // Create the canvas initialized to opaque white.
  std::unique_ptr<SkCanvas> canvas(CreatePlatformCanvas(16, 16, true));
...
TEST(PlatformCanvas, TranslateLayer) {
  EDGE_DISABLED_WCOS_PENDING(TranslateLayer, 22790288)
  // Create the canvas initialized to opaque white.
  std::unique_ptr<SkCanvas> canvas = CreatePlatformCanvas(16, 16, true);
