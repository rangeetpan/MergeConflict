...
<<<<<<< HEAD
#include "content/public/common/pdf_util.h"
=======
...
#else
  histogram_tester.ExpectBucketCount("Microsoft.Pdf.PluginLoadStatus",
                                     content::kLoadedFullPagePdfWithPdfium, 1);
#endif
}
...
#else
  histogram_tester.ExpectBucketCount("Microsoft.Pdf.PluginLoadStatus",
                                     content::kLoadedEmbeddedPdfWithPdfium, 1);
#endif
}
