...
>>>>>>> 451f39f594f8ca1890370f5a49663a0d8ca625a4
...
void AutofillField::set_ml_type(ServerFieldType type) {
...
AutofillType AutofillField::ComputedType() const {
  ...
  if (base::FeatureList::IsEnabled(
          features::kAutofillEdgeStateLabelPredictor) ||
      base::FeatureList::IsEnabled(
          features::kAutofillEdgeEmailLabelPredictor)) {
    if (ml_type_ != NO_SERVER_DATA)
      return AutofillType(ml_type_);
  }
