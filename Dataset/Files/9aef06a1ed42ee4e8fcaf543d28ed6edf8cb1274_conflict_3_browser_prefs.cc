...
#include "chrome/browser/accessibility/hc_with_theme_bubble_prefs.h"
...
#include "chrome/browser/edge_edu_policy/bing_ads_suppression_prefs.h"
...
#include "chrome/browser/privacy/privacy_cleanup_handler.h"
...
#include "chrome/browser/ui/session_admin_bubble.h"
#include "chrome/browser/ui/tabs/pinned_tab_codec.h"
#include "chrome/browser/ui/toolbar/chrome_location_bar_model_delegate.h"
#if !defined(OS_ANDROID)
#include "chrome/browser/ui/webui/edge_surf/edge_surf_ui.h"
#endif
...
>>>>>>> 1843d76f8885c7ba1059408b8a11b559ff86845e
...
#include "components/edge_trust/ad_blocking/ads_checker.h"
#if defined(MICROSOFT_EDGE_BUILD) && !defined(OS_ANDROID)
#include "components/dom_distiller/core/edge_distilled_page_prefs.h"
#else
...
#include "components/edge_share/core/common/edge_enhanced_url_copy_paste_prefs.h"
#include "components/edge_smartscreen/buildflags/buildflags.h"
#include "components/edge_vertical_tabs/common/vertical_tabs_prefs.h"
#include "components/feature_engagement/buildflags.h"
#include "components/flags_ui/pref_service_flags_storage.h"
#include "components/image_fetcher/core/cache/image_cache.h"
#include "components/invalidation/impl/edge_fcm_network_handler.h"
#include "components/invalidation/impl/edge_per_user_topic_subscription_manager.h"
...
#include "components/password_manager/core/browser/edge_password_bubble_experiment.h"
...
#include "components/wdag_win/prefs.h"
#include "components/wdag_win/pref_names.h"
#endif

#if defined(MICROSOFT_EDGE_BUILD)
#include "components/edge_learning_tools/core/prefs/learning_tools_prefs.h"
#endif
...
#include "chrome/browser/extensions/api/edge_pinning_wizard_private/edge_pinning_wizard_model.h"
#endif
#include "chrome/browser/extensions/api/ntp_settings_private/ntp_settings_private_api.h"
...
#include "chrome/browser/ui/webui/edge_settings/edge_settings_ui.h"
...
#include "chrome/browser/notifications/win/platform_notification_softlanding_prefs.h"
...
#include "components/captive_portal/content/edge_browser_captive_portal_features.h"
#include "components/captive_portal/content/edge_pref_names.h"
#endif

#if !EXCLUDED_FROM_EDGE
#include "chrome/browser/edge_auth/guided_switch/edge_guided_switch_prefs.h"
#include "components/signin/internal/identity_manager/edge_signin_pref_utils.h"
#endif

#include "chrome/browser/ui/tabs/edge_automatic_tab_freeze.h"
#include "services/network/public/cpp/edge_circuit_breaker_state.h"
...
void RegisterProfilePrefsForMigration(
  ...
  registry->RegisterBooleanPref(
      omnibox::prefs::kSingleWordIntranet, false,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      omnibox::prefs::kOmniboxMSBProviderEnabled, true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
...
void RegisterLocalState(PrefRegistrySimple* registry) {
  ...
  ad_blocking::AdsChecker::RegisterLocalStatePrefs(registry);
...
#if !defined(OS_ANDROID)
  AutomaticTabFreeze::RegisterPrefs(registry);
#endif
  signin::IdentityManager::RegisterLocalStatePrefs(registry);
  IntranetRedirectDetector::RegisterPrefs(registry);
#if defined(MICROSOFT_EDGE_BUILD) && defined(OS_WIN)
  extensions::microsoft_edge::EdgePinningWizardModel::RegisterLocalStatePrefs(
      registry);
#endif

#if !defined(OS_ANDROID)
  first_run::RegisterPrefs(registry);
  first_run::RegisterFrePref(registry);
  first_run::RegisterWhatsNewPagePref(registry);
#endif
  ...
  network::CircuitBreakerState::RegisterLocalStatePrefs(registry);
  OriginTrialPrefs::RegisterPrefs(registry);
  password_manager::PasswordManager::RegisterLocalPrefs(registry);
  policy::BrowserPolicyConnector::RegisterPrefs(registry);
  policy::PolicyStatisticsCollector::RegisterPrefs(registry);
  PrefProxyConfigTrackerImpl::RegisterPrefs(registry);
  privacy::PrivacyCleanupHandler::RegisterLocalStatePrefs(registry);
...
#if BUILDFLAG(ENABLE_SMARTSCREEN)
  smartscreen::RegisterLocalStatePrefs(registry);
#endif
...
#if BUILDFLAG(ENABLE_WDAG)
  wdag::RegisterLocalStatePrefs(registry);
#endif
  ...
  softlanding::prefs::RegisterLocalPrefs(registry);
#endif  // defined(OS_WIN)
...
#if defined(OS_WIN)
  registry->RegisterStringPref(prefs::kLastPinMigrationOnEdgeVersion,
                               std::string());

  registry->RegisterStringPref(prefs::kLastPinMigrationOnOSVersion,
                               std::string());

  registry->RegisterBooleanPref(prefs::kLastEdgeuwpPinMigrationSuccess, false);
  registry->RegisterStringPref(prefs::kLastEdgeuwpPinMigrationOnOSVersion,
                               std::string());
  registry->RegisterStringPref(prefs::kLastEdgeuwpPinMigrationOnEdgeVersion,
                               std::string());

  registry->RegisterBooleanPref(prefs::kDeleteDataOnMigration, false);
#endif // defined(OS_WIN)
#if defined(MICROSOFT_EDGE_BUILD)
  bing_ads_suppression::RegisterLocalStatePrefs(registry);
#endif
}
...
>>>>>>> 1843d76f8885c7ba1059408b8a11b559ff86845e
...
#if defined(MICROSOFT_EDGE_BUILD)
  edge::learning_tools::RegisterProfilePrefs(registry);
#endif
  edge::VerticalTabsPrefs::RegisterProfilePrefs(registry);
  edge_password_bubble_experiment::RegisterPrefs(registry);
#if !defined(OS_ANDROID)
  edge_share::RegisterProfilePrefs(registry);
  EdgeSurfUI::RegisterProfilePrefs(registry);
#endif
...
#if EXCLUDED_FROM_EDGE || defined(OS_ANDROID)
...
#if !BUILDFLAG(ENABLE_SMARTSCREEN)
  password_protection::RegisterProfilePrefs(registry);
#endif
  payments::RegisterProfilePrefs(registry);
#if defined(MICROSOFT_EDGE_BUILD)
  PersonalizedDataCollectionRequest::RegisterProfilePrefs(registry);
#endif
  ...
  // This setting allows captive portal feature to selectively run on
  // operating systems supporting it.
#if BUILDFLAG(ENABLE_CAPTIVE_PORTAL_DETECTION)
  registry->RegisterBooleanPref(
      captive_portal::prefs::kResolveNavigationErrorsUseWebServiceEnabled,
      features::edge::IsResolveNavigationErrorsUseWebServiceEnabled(),
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
#endif
...
#if defined(TOOLKIT_VIEWS)
  session_admin_bubble::RegisterProfilePrefs(registry);
#endif
  SessionStartupPref::RegisterProfilePrefs(registry);
  SharingSyncPreference::RegisterProfilePrefs(registry);
#if BUILDFLAG(ENABLE_SMARTSCREEN)
  smartscreen::RegisterProfilePrefs(registry);
#endif
  ...
  syncer::FCMNetworkHandler::RegisterProfilePrefs(registry);
  TemplateURLPrepopulateData::RegisterProfilePrefs(registry);
  registry->RegisterBooleanPref(prefs::kLocalProvidersEnabled, true);
  ...
  extensions::NtpSettingsPrivate::RegisterProfilePrefs(registry);
  ...
  feature_engagement::FeedbackTracker::RegisterProfilePrefs(registry);
#endif
  ...
  first_run::RegisterEdgeImportPrefs(registry);
  first_run::RegisterEdgeAutoImportPrefs(registry);
  first_run::RegisterEdgeManualImportPrefs(registry);
  first_run::RegisterEdgeFRESplashPrefs(registry);
#if EXCLUDED_FROM_EDGE
...
#if defined(OS_WIN)
  dual_engine::DualEnginePrefs::RegisterProfilePrefs(registry);
#endif

#if !defined(OS_ANDROID)
  EdgeSettingsUI::RegisterProfilePrefs(registry);
#endif

#if !defined(OS_ANDROID)
  EdgeAutoplayConfig::RegisterProfilePrefs(registry);
#endif
  ...
  accessibility_prefs::RegisterHCWithThemeBubbleUserPrefs(registry);
  RegisterBrowserViewProfilePrefs(registry);
#endif

  // Edge registrations below to reduce merge conflicts.
#if !EXCLUDED_FROM_EDGE
  guided_switch::RegisterProfilePrefs(registry);
  share_system::helper::RegisterProfilePrefs(registry);
#endif  // !EXCLUDED_FROM_EDGE
...
#if !EXCLUDED_FROM_EDGE
  MigrateDeprecatedEdgeSigninPrefs(profile_prefs);
#endif
