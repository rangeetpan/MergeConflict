...
>>>>>>> 6ff84a092b35c20e24be4aef5962bea2e2f7f0ae
...
void PaintManager::OnFlushComplete(int32_t) {
  ...
  if (!first_render_time_recorded_ && first_paint_complete_) {
    first_render_time_recorded_ = true;
    client_->RecordFirstRenderTime();
  }
  ...
  TRACE_EVENT0("pdf_plugin", "RenderingComplete");
}
