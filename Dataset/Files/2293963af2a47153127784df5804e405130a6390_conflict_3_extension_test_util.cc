...
<<<<<<< HEAD
#include "components/microsoft/core/common/switches.h"
#include "components/version_info/channel.h"
=======
>>>>>>> ea70463761a7cdf41df22f6e2c90ed5004aa9aca
...
<<<<<<< HEAD
void SetHashFetchURL(const GURL& new_url) {
  base::CommandLine* command_line = base::CommandLine::ForCurrentProcess();
  command_line->AppendSwitchASCII(switches::kTestHashUrl, new_url.spec());
  extensions::ExtensionsClient::Get()->InitializeWebStoreUrls(command_line);
}
